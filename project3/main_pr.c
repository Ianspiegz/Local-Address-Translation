...
int TLBcount = 0;     /*counter to track the number of entries in the TLB*/
...
/*function to insert PN & FN into TLB with FIFO page replacement*/

void TLBFIFOPR(int PN, int FN){

   

    int i;  /*if in Tlb, break*/
...

{
   ...
   /*reads all logical addresses*/
    ...
    while ( fgets(address, BUFFER_SIZE, addressesf) != NULL) {
        ...
        NTA++;  /*used for calculations on oncoming code*/
